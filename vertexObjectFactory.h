...
const std::map<string, std::variant<shared_ptr<AlternationTest>,shared_ptr<Agglutination>>> registry {
				{"AlternationTest",VertexObjectFactory::createInstanceAlternationTest()},
				{"Agglutination",  VertexObjectFactory::createInstanceAgglutination()}
};
